          ...
          >
            ...
            <div className="py-2 w-[100%] flex flex-row items-center justify-center">
              <button
                disabled={loading}
                type="submit"
                className={`bg-slate-800 text-white px-4 py-2 rounded-full shadow-sm shrink-0 w-full flex gap-2 items-center justify-center hover:bg-pink-400 hover:transition-all hover:duration-300 disabled:bg-slate-600 disabled:cursor-not-allowed`}
              >
                {loading ? (
                  <>
                    Connecting... <Spinner />
                  ...
                  <>
                    Login
                    <LoginIcon className="h-5 w-5 text-white" color="white" />
                  </>
                )}
              </button>
            </div>
